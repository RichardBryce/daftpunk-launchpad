...
let iconSet = {
    ...
    pause: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" fill="currentColor"></defs><rect class="cls-1" width="48" height="48"/><path d="M24,4.8A19.2,19.2,0,1,0,43.2,24,19.19,19.19,0,0,0,24,4.8Zm0,34.8A15.6,15.6,0,1,1,39.6,24,15.63,15.63,0,0,1,24,39.6Z"/><rect x="18" y="16.8" width="3.6" height="14.4"/><rect x="26.4" y="16.8" width="3.6" height="14.4"/></svg>',
    stop: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="48px" height="48px" fill="currentColor"><g><path d="M24,4.8C13.4,4.8,4.8,13.4,4.8,24S13.4,43.2,24,43.2S43.2,34.6,43.2,24S34.6,4.8,24,4.8z M24,39.6c-8.6,0-15.6-7-15.6-15.6S15.4,8.4,24,8.4s15.6,7,15.6,15.6S32.6,39.6,24,39.6z" /><rect x="16.8" y="16.8" width="14.4" height="14.4" /></g></svg>'
};
