...
let iconSet = {
    baseElement: '',
    play: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48"><path d="M24,4.8A19.2,19.2,0,1,0,43.2,24,19.19,19.19,0,0,0,24,4.8Zm0,34.8A15.6,15.6,0,1,1,39.6,24,15.63,15.63,0,0,1,24,39.6Z"/><polygon points="19.2 32.4 32.4 24 19.2 15.6 19.2 32.4"/></svg>',
    pause: '<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 20 20" viewBox="0 0 20 20" height="48px" width="48px" fill="currentColor"><g><rect fill="none" height="20" width="20"/></g><g><path d="M10,2c-4.42,0-8,3.58-8,8s3.58,8,8,8s8-3.58,8-8S14.42,2,10,2z M10,16.5c-3.58,0-6.5-2.92-6.5-6.5S6.42,3.5,10,3.5 s6.5,2.92,6.5,6.5S13.58,16.5,10,16.5z"/><rect height="6" width="1.5" x="7.5" y="7"/><rect height="6" width="1.5" x="11" y="7"/></g></svg>',
    stop: '<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 20 20" viewBox="0 0 48 48" width="48px" height="48px" fill="currentColor"><g><path d="M24,4.8C13.4,4.8,4.8,13.4,4.8,24S13.4,43.2,24,43.2S43.2,34.6,43.2,24S34.6,4.8,24,4.8z M24,39.6c-8.6,0-15.6-7-15.6-15.6S15.4,8.4,24,8.4s15.6,7,15.6,15.6S32.6,39.6,24,39.6z" /><rect x="16.8" y="16.8" width="14.4" height="14.4" /></g></svg>'
};
